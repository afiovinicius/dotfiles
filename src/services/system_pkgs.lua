--- ============================================================================
--- ORZHOV ARCH - INSTALAÇÃO DOS PACOTES PADRÕES PARA O SISTEMA
--- ============================================================================
...
function systemBase.install_gpu_packages()
	...
	local selected_gpus =
		aux.multiselect("Quais placas gráficas deseja suporte? (Espaço: marcar | Enter: confirmar)", gpu_options)
